...
public interface MailConfiguration {
    ...
    /**
     * @return enable status for interrupting idle method for IMAP. Default 'false'
     */
    boolean isNotificationInterruptIdleEnabled();

    /**
     * @return duration for interrupt idle method for IMAP. Default PT29M
     */
    Duration getNotificationInterruptIdleDuration();
